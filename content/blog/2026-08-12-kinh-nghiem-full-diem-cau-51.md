...
- Đừng vừa đọc vừa cố dịch từng từ.
- Hãy đọc nhanh toàn bộ để nắm được nội dung cơ bản và mạch liên kết giữa các câu.

## BƯỚC 2: SCAN TỪ VỰNG

- Sau khi hiểu nội dung, hãy scan các từ/ cụm từ phù hợp.
- Nhiều trường hợp từ khóa/ gợi ý cho đáp án đã nằm ngay trong đề bài, vì vậy hãy tận dụng tối đa những từ vựng đã có sẵn thay vì cố nghĩ một đáp án hoàn toàn mới.
- **TIP:** Đừng chỉ tìm những từ giống y chang. Hãy tìm những từ có liên quan về nghĩa: đồng nghĩa, trái nghĩa, hoặc gần nghĩa.
- Đặc biệt, hãy chú ý: Từ vựng thường có tính liên quan theo kiểu **CUỐI CÂU TRƯỚC - ĐẦU CÂU SAU / TIÊU ĐỀ**

## BƯỚC 3: NGỮ PHÁP - CÀNG CHẮC CÀNG TỐT

- Câu 51 không phải là chỗ để thử những ngữ pháp quá khó
- Hãy tư duy đơn giản
- Ưu tiên những ngữ pháp sơ cấp / trung cấp quen thuộc và chắc chắn, thay vì cố dùng những ngữ pháp nâng cao nhưng dễ mắc lỗi.

## BƯỚC 4: KIỂM TRA THEO CÂU THẦN CHÚ
